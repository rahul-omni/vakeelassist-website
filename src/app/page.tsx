          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-lg overflow-hidden">
              <div className="p-8 border-b border-gray-200">
                ...
                <div className="text-5xl font-extrabold text-gray-900 mb-6">₹15,000<span className="text-gray-500 text-sm">/month</span></div>
                </div>
            ...
            <div className="bg-white rounded-xl border-2 border-gray-800 shadow-xl scale-105 relative">
              ...
              <div className="p-8 border-b border-gray-200 mt-6">
                ...
                <div className="text-5xl font-extrabold text-gray-900 mb-6">₹39,000<span className="text-gray-500 text-sm">/month</span></div>
                </div>
