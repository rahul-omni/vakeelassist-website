...
export const metadata: Metadata = {
  title: "Cancellation & Refunds Policy | Vakeel Assist",
  description:
    "Read the Vakeel Assist Cancellation & Refunds Policy for subscription cancellation, refunds, and support details.",
