...
export const metadata: Metadata = {
  title: "Shipping Policy | Vakeel Assist",
  description:
    "Review the Vakeel Assist Shipping Policy for delivery information related to any physical materials or documentation provided with our services.",
